export const moon_and_planets = [
    {
        ...
        topics: ["Tipo: Rochoso", "Diâmetro: 4.880 km", "Temperaturas: -173°C (Min) 427° (Max)",  "Luas: Nenhuma", "Curiosidade: Da superfície de Mercúrio, o Sol pareceria mais de três vezes maior do que quando visto da Terra, e a luz solar seria até sete vezes mais brilhante."],
        id: "Mercury",
        type: "planet",
        min: 82_500_000,
        max: 1_446_000_000
    },
    {
        ...
        topics: ["Tipo: Rochoso", "Diâmetro: 12.104 km", "Temperaturas: ~475°C (Min) ~475° (Max)", "Luas: Nenhuma", "Curiosidade: A pressão atmosférica na superfície de Vênus é tão alta (90x a da Terra) que o som viajaria mais devagar e soaria diferente, sua voz pareceria mais grave e abafada."],
        id: "Venus",
        type: "planet",
        min: 39_790_000,
        max: 1_736_000_000
    },
    {
        ...
        topics: ["Tipo: Rochoso", "Diâmetro: 12.742 km", "Temperaturas: -89°C (Min) 56,7°C (Max)", "Luas: 1 (a Lua)", "Curiosidade: Cerca de 70% da superfície da Terra é coberta por água, mas o planeta tem menos de 1% de água potável disponível na superfície."],
        id: "Earth",
        type: "planet",
        min: 147.1,
        max: 152.1
    },
    {
        ...
        topics: ["Tipo: Rochoso", "Diâmetro: 6.794 km", "Temperaturas: -140°C (Min) 30°C (Max)", "Luas: 2 (Fobos e Deimos)", "Curiosidade: Marte abriga o maior vulcão do Sistema Solar: Olympus Mons, com 22 km de altura, quase 3x o Monte Everest!"],
        id: "Mars",
            type: "planet",
            min: 55_650_000,
            max: 2_671_000_000
    },
    {
        ...
        topics: ["Tipo: Gasoso (gigante)", "Diâmetro: 142.984 km", "Temperaturas: -145°C (Min) -130°C (Max)", "Luas: +90 (destaques: Ganimedes, Io, Europa e Calisto)", "Curiosidade: É o maior planeta do Sistema Solar e emite mais energia do que recebe do Sol."],
        id: "Jupiter",
        type: "planet",
        min: 591_970_000,
        max: 6_454_000_000
    },
    {
        ...
        topics: ["Tipo: Gasoso (gigante)", "Diâmetro: 120.536 km", "Temperaturas: -130°C (Min) -185°C (Max)", "Luas: +80 (destaque: Titã)", "Curiosidade: Além dos anéis, Saturno tem uma formação em forma de hexágono gigante no polo norte, uma corrente de jato atmosférica hexagonal estável."],
        id: "Saturn",
        type: "planet",
        min: 1_204_280_000,
        max: 11_046_000_000
    },
    {
        ...
        topics: ["Tipo: Gasoso (gigante gelado)", "Diâmetro: 51.118 km", "Temperaturas: -224°C (Min) -197°C (Max)", "Luas: 27", "Curiosidade: Em simulações laboratoriais, acredita-se que dentro de Urano (e Netuno), a pressão extrema pode causar chuvas de diamantes, com carbono se cristalizando no interior profundo."],
        id: "Uranus",
        type: "planet",
        min: 2_586_880_000,
        max: 21_089_000_000
    },
    {
        ...
        topics: ["Tipo: Gasoso (gigante gelado)", "Diâmetro: 49.538 km", "Temperaturas: -218°C (Min) -200°C (Max)", "Luas: 14 (destaque: Tritão)", "Curiosidade: Possui os ventos mais rápidos do Sistema Solar, chegando a mais de 2.000 km/h."],
        id: "Neptune",
        type: "planet",
        min: 4_311_002_000,
        max: 31_317_000_000
