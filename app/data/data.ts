export const moon_and_planets = [
    {
        ...
        topics: ["Tipo: Rochoso", "Diâmetro: ~4.880 km", "Temperatura média: ~167°C", "Luas: Nenhuma", "Curiosidade: É o planeta mais próximo do Sol, mas não o mais quente, pois quase não tem atmosfera para reter calor."],
        id: "Mercury",
        type: "planet",
        min: 82_500_000,
        max: 1_446_000_000
    ...
    {
        name: "Vênus",
        description: "Vênus é o segundo planeta do Sistema Solar e é semelhante em tamanho à Terra. No entanto, sua atmosfera é muito densa e composta quase inteiramente de dióxido de carbono, o que provoca um forte efeito estufa. Como resultado, é um dos planetas mais quentes, mesmo estando mais distante do Sol que Mercúrio.",
        topics: ["Tipo: Rochoso", "Diâmetro: ~12.104 km", "Temperatura média: ~464°C", "Luas: Nenhuma", "Curiosidade: É o planeta mais quente do Sistema Solar, devido ao efeito estufa intenso causado por sua atmosfera espessa de dióxido de carbono."],
        id: "Venus",
        type: "planet",
        min: 39_790_000,
        max: 1_736_000_000
    },
    {
        ...
        topics: ["Tipo: Rochoso", "Diâmetro: ~12.742 km", "Temperatura média: ~15°C", "Luas: 1 (a Lua)", "Curiosidade: É o único planeta conhecido com vida e água em estado líquido em abundância."],
        id: "Earth",
        type: "planet",
        min: 147.1,
        max: 152.1
    },
    {
        ...
        topics: ["Tipo: Rochoso", "Diâmetro: ~16.779 km", "Temperatura média: ~-60°C", "Luas: 2 (Fobos e Deimos)", "Curiosidade: Apresenta sinais de que já teve água líquida no passado."],
        id: "Mars",
        type: "planet",
        min: 55_650_000,
        max: 2_671_000_000
    },
    {
        ...
        topics: ["Tipo: Gasoso (gigante)", "Diâmetro: ~139.820 km", "Temperatura média: ~-110°C", "Luas: +90 (destaques: Ganimedes, Io, Europa e Calisto)", "Curiosidade: É o maior planeta do Sistema Solar e possui uma tempestade gigante conhecida como a Grande Mancha Vermelha."],
        id: "Jupiter",
        type: "planet",
        min: 591_970_000,
        max: 6_454_000_000
    },
    {
        ...
        topics: ["Tipo: Gasoso (gigante)", "Diâmetro: ~116.460 km", "Temperatura média: ~-140°C", "Luas: +80 (destaque: Titã)", "Curiosidade: Famoso por seus impressionantes anéis compostos de gelo e poeira."],
        id: "Saturn",
        type: "planet",
        min: 1_204_280_000,
        max: 11_046_000_000
    },
    {
        ...
        topics: ["Tipo: Gasoso (gigante gelado)", "Diâmetro: ~50.724 km", "Temperatura média: ~-195°C", "Luas: 27", "Curiosidade: Seu eixo de rotação é tão inclinado que praticamente rola ao redor do Sol."],
        id: "Uranus",
        type: "planet",
        min: 2_586_880_000,
        max: 21_089_000_000
    },
    {
        ...
        topics: ["Tipo: Gasoso (gigante gelado)", "Diâmetro: ~49.244 km", "Temperatura média: ~-200°C", "Luas: 14 (destaque: Tritão)", "Curiosidade: Possui os ventos mais rápidos do Sistema Solar, chegando a mais de 2.000 km/h."],
        id: "Neptune",
        type: "planet",
        min: 4_311_002_000,
        max: 31_317_000_000
